...
class HistoryMonth : BaseModel() {
    ...
    fun FillBy(stockCode: String, csvRecord: CSVRecord): HistoryMonth {
        code = stockCode
    ...
    companion object : Model.Find<Long, HistoryMonth>() {
        ...
        fun FindOrCreate(code: String, date: JDateTime): HistoryMonth {
            return HistoryMonth.where()
                    .eq("code", code)
                    .eq("t_date", date)
                    .findUnique() ?: HistoryMonth()
        }
    }
}
