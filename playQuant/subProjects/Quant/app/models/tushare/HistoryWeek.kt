...
class HistoryWeek : BaseModel() {
    ...
    fun FillBy(stockCode: String, csvRecord: CSVRecord): HistoryWeek {
        code = stockCode
    ...
    companion object : Model.Find<Long, HistoryWeek>() {
        ...
        fun FindOrCreate(code: String, date: JDateTime): HistoryWeek {
            return HistoryWeek.where()
                    .eq("code", code)
                    .eq("t_date", date)
                    .findUnique() ?: HistoryWeek()
        }
    }
