...
@Entity
@Table(name = "history5min")
class History5Min :BaseModel(){
    ...
    fun FillBy(stockCode: String, csvRecord: CSVRecord): History5Min {
        code = stockCode
    ...
    companion object : Model.Find<Long, History5Min>() {
        ...
        fun FindOrCreate(code: String, date: JDateTime): History5Min {
            return History5Min.where()
                    .eq("code", code)
                    .eq("t_date", date)
                    .findUnique() ?: History5Min()
        }
    }
}